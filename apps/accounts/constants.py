...
TIMEZONES_CHOICES = [
    ...
    ("America/Punta_Arenas", "(GMT-04:00) Punta Arenas"),
    ...
    ("Asia/Bishkek", "(GMT+05:00) Bishkek"),
...
LANGUAGES_CHOICES = [lang_opt for lang_opt in LANGUAGES if lang_opt[0] in allowed_languages]
